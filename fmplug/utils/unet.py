...
class AttentionPool2d(nn.Module):
    ...
    def __init__(
        ...
        output_dim: int = None,  # type: ignore
    ):
        super().__init__()
...
class AttentionBlock(nn.Module):
    ...
    def __init__(
        ...
        if num_head_channels == -1:
            ...
            ), f"q,k,v channels {channels} is not divisible by num_head_channels {num_head_channels}"  # noqa
...
class QKVAttentionLegacy(nn.Module):
    """
    A module which performs QKV attention. Matches legacy
    QKVAttention + input/ouput heads shaping
    """
...
class GANLoss(nn.Module):
    ...
    def get_target_tensor(self, prediction, target_is_real):
        ...
        Parameters:
            ...
            target_is_real (bool) - - if the ground truth label is for
    ...
    def __call__(self, prediction, target_is_real):
        ...
        Parameters:
            ...
            target_is_real (bool) - - if the ground truth
            label is for real images or fake images
...
def cal_gradient_penalty(
    ...
    """Calculate the gradient penalty loss, used in
    ...
    Arguments:
        ...
        device (str)                -- GPU / CPU: from
            torch.device('cuda:{}'.format(self.gpu_ids[0])) if
